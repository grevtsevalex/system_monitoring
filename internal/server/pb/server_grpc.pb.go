...
type MonitoringServiceClient interface {
	GetMetrics(ctx context.Context, in *GetMetricsRequest, opts ...grpc.CallOption) (MonitoringService_GetMetricsClient, error)
}
...
func (c *monitoringServiceClient) GetMetrics(ctx context.Context, in *GetMetricsRequest, opts ...grpc.CallOption) (MonitoringService_GetMetricsClient, error) {
	stream, err := c.cc.NewStream(ctx, &MonitoringService_ServiceDesc.Streams[0], "/server.MonitoringService/GetMetrics", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *monitoringServiceGetMetricsClient) Recv() (*Snapshot, error) {
	m := new(Snapshot)
...
type MonitoringServiceServer interface {
	GetMetrics(*GetMetricsRequest, MonitoringService_GetMetricsServer) error
...
func (UnimplementedMonitoringServiceServer) GetMetrics(*GetMetricsRequest, MonitoringService_GetMetricsServer) error {
...
func (x *monitoringServiceGetMetricsServer) Send(m *Snapshot) error {
...
var MonitoringService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.MonitoringService",
